...
#include "platform.h"
	...
	typedef enum xtensa_insn_group
	{
		...
		XTENSA_GRP_JUMP = CS_GRP_JUMP,
		XTENSA_GRP_CALL = CS_GRP_CALL,
		XTENSA_GRP_RET = CS_GRP_RET,
		XTENSA_GRP_INT = CS_GRP_INT,
		XTENSA_GRP_BRANCH_RELATIVE = CS_GRP_BRANCH_RELATIVE,
